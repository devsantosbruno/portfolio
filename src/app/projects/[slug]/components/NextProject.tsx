...
export function NextProject({ project, projectsQuantity }: NextProject) {
	...
	return (
		<div className="bg-white text-center text-black">
			<Container>
				<div className="pt-80 pb-52 flex justify-center text-center items-center">
					<h2
				...
				<div className="flex justify-center items-center border-b border-black">
					<div className="relative overflow-hidden group">
						<div className="-mb-8">
							...
							<div className="group-hover:scale-75 transition duration-500 mt-5">
								<h2 className="text-8xl font-bold tracking-tighter leading-[0.8] text-black group-hover:text-slate-800 transition duration-1000">
									{title}
								</h2>
							</div>
						</div>
						...
						<Image
							...
							width={800}
							height={800}
							className="w-full max-w-[600px] h-[400px] object-cover object-center translate-y-[300px] group-hover:translate-y-0 transition duration-500 shadow-2xl shadow-black"
							alt={`${title} preview`}
						/>
				...
				<button
					type="button"
					className="mx-auto mt-20 w-fit flex items-center justify-center rounded-full border px-10 py-3 font-thin bg-[#242424] hover:bg-lime-400 border-white hover:border-lime-400 text-white hover:text-[#242424] shadow-2xl hover:shadow-lime-400 transition duration-500"
